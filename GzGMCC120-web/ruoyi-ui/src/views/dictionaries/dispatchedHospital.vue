...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        dictValue: [
          { required: true, message: "高危因素名称不能为空", trigger: "blur" },
        ],
      },
      // 遮罩层
      loading: true,
      ...
      tableData: [
        {
          id: "1", // 数据id
          highRiskFactor: "1", // 高危因素
          index: "1", // 序号
          modificationTime: "2020-03-02", // 修改时间
        },
        {
          id: "2",
          index: "2",
          modificationTime: "2020-03-02", // 修改时间
          highRiskFactor: "21", // 高危因素
        },
        {
          id: "3",
          index: "3",
          modificationTime: "2020-03-02", // 修改时间
          highRiskFactor: "3", // 高危因素
        },
        {
          id: "4",
          highRiskFactor: "4", // 高危因素
          index: "4",
          modificationTime: "2020-03-02", // 修改时间
        },
      ],
